...
# Look at distribution of visit_age to decide categories for age groups
filter2 %>%
  ggplot(aes(x=visit_age)) +
  geom_histogram() +
  theme_classic()+
  labs(title = "Histogram of age distribution for filter2 results", x="Age of patient at visit time", y="Number of patients")
