...
# Filter hypothesis2 dataset for NA values in the total_vaccines_received values and for vaccines in NULL category
filter2 <- hypothesis2 %>% filter(total_vaccines_received != "NA", vaccine != "NULL") 
